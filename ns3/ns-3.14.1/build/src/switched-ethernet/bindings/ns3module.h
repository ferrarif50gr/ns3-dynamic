...
typedef struct {
    PyObject_HEAD
    ns3::SwitchedEthernetDeviceRec *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3SwitchedEthernetDeviceRec;


extern PyTypeObject PyNs3SwitchedEthernetDeviceRec_Type;

extern std::map<void*, PyObject*> PyNs3SwitchedEthernetDeviceRec_wrapper_registry;

typedef struct {
    PyObject_HEAD
    ns3::SwitchedEthernetHelper *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyNs3SwitchedEthernetHelper;


extern PyTypeObject PyNs3SwitchedEthernetHelper_Type;

class PyNs3SwitchedEthernetHelper__PythonHelper : public ns3::SwitchedEthernetHelper
{
public:
    PyObject *m_pyself;
    PyNs3SwitchedEthernetHelper__PythonHelper(ns3::SwitchedEthernetHelper const & arg0)
        : ns3::SwitchedEthernetHelper(arg0), m_pyself(NULL)
        {}

    PyNs3SwitchedEthernetHelper__PythonHelper()
        : ns3::SwitchedEthernetHelper(), m_pyself(NULL)
        {}
    ...
    virtual ~PyNs3SwitchedEthernetHelper__PythonHelper()
    {
        Py_CLEAR(m_pyself);
    }
...
typedef struct {
    PyObject_HEAD
    ns3::SwitchedEthernetChannel *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyNs3SwitchedEthernetChannel;


extern PyTypeObject PyNs3SwitchedEthernetChannel_Type;

class PyNs3SwitchedEthernetChannel__PythonHelper : public ns3::SwitchedEthernetChannel
{
public:
    PyObject *m_pyself;
    PyNs3SwitchedEthernetChannel__PythonHelper(ns3::SwitchedEthernetChannel const & arg0)
        : ns3::SwitchedEthernetChannel(arg0), m_pyself(NULL)
        {}

    PyNs3SwitchedEthernetChannel__PythonHelper()
        : ns3::SwitchedEthernetChannel(), m_pyself(NULL)
        {}
    ...
    virtual ~PyNs3SwitchedEthernetChannel__PythonHelper()
    {
        Py_CLEAR(m_pyself);
    }


    static PyObject * _wrap_NotifyConstructionCompleted(PyNs3SwitchedEthernetChannel *self);
    inline void NotifyConstructionCompleted__parent_caller()
    { ns3::ObjectBase::NotifyConstructionCompleted(); }

    static PyObject * _wrap_NotifyNewAggregate(PyNs3SwitchedEthernetChannel *self);
    inline void NotifyNewAggregate__parent_caller()
    { ns3::Object::NotifyNewAggregate(); }

    static PyObject * _wrap_DoStart(PyNs3SwitchedEthernetChannel *self);
    inline void DoStart__parent_caller()
    { ns3::Object::DoStart(); }

    static PyObject * _wrap_DoDispose(PyNs3SwitchedEthernetChannel *self);
    ...
    {
      static ns3::TypeId tid = ns3::TypeId ("PyNs3SwitchedEthernetChannel__PythonHelper")
        .SetParent< ns3::SwitchedEthernetChannel > ()
        ;
      return tid;
    }
};

NS_OBJECT_ENSURE_REGISTERED (PyNs3SwitchedEthernetChannel__PythonHelper);


typedef struct {
    PyObject_HEAD
    ns3::SwitchedEthernetNetDevice *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyNs3SwitchedEthernetNetDevice;


extern PyTypeObject PyNs3SwitchedEthernetNetDevice_Type;
