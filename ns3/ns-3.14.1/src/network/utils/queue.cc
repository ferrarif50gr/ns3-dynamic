...
//NS_LOG_UNCOND("Enqueue: packet =" << p << " UID is " << p->GetUid () << " at time " << Simulator::Now() );//a
  //
...
//NS_LOG_UNCOND("Dequeue: packet =" << packet << " UID is " << packet->GetUid () << " at time " << Simulator::Now() );//a
