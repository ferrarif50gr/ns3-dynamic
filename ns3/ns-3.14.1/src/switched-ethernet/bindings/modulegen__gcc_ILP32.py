...
def module_init():
    root_module = Module('ns.switched_ethernet', cpp_namespace='::ns3')
    return root_module

def register_types(module):
    root_module = module.get_root()
    
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::FullDuplexWireState [enumeration]
    module.add_enum('FullDuplexWireState', ['IDLE_STATE', 'TRANSMITTING_STATE', 'PROPAGATING_STATE'])
    ...
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::SwitchedEthernetDeviceRec [class]
    module.add_class('SwitchedEthernetDeviceRec')
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::SwitchedEthernetHelper [class]
    module.add_class('SwitchedEthernetHelper', parent=[root_module['ns3::PcapHelperForDevice'], root_module['ns3::AsciiTraceHelperForDevice']])
    ...
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::SwitchedEthernetChannel [class]
    module.add_class('SwitchedEthernetChannel', parent=root_module['ns3::Channel'])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): ns3::SwitchedEthernetNetDevice [class]
    module.add_class('SwitchedEthernetNetDevice', parent=root_module['ns3::NetDevice'])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): ns3::SwitchedEthernetNetDevice::EncapsulationMode [enumeration]
    module.add_enum('EncapsulationMode', ['ILLEGAL', 'DIX', 'LLC'], outer_class=root_module['ns3::SwitchedEthernetNetDevice'])
...
def register_methods(root_module):
    ...
    register_Ns3SwitchedEthernetDeviceRec_methods(root_module, root_module['ns3::SwitchedEthernetDeviceRec'])
    register_Ns3SwitchedEthernetHelper_methods(root_module, root_module['ns3::SwitchedEthernetHelper'])
    ...
    register_Ns3SwitchedEthernetChannel_methods(root_module, root_module['ns3::SwitchedEthernetChannel'])
    register_Ns3SwitchedEthernetNetDevice_methods(root_module, root_module['ns3::SwitchedEthernetNetDevice'])
...
def register_Ns3SwitchedEthernetDeviceRec_methods(root_module, cls):
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::SwitchedEthernetDeviceRec::SwitchedEthernetDeviceRec(ns3::SwitchedEthernetDeviceRec const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::SwitchedEthernetDeviceRec const &', 'arg0')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::SwitchedEthernetDeviceRec::SwitchedEthernetDeviceRec() [constructor]
    cls.add_constructor([])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::SwitchedEthernetDeviceRec::SwitchedEthernetDeviceRec(ns3::Ptr<ns3::SwitchedEthernetNetDevice> device) [constructor]
    cls.add_constructor([param('ns3::Ptr< ns3::SwitchedEthernetNetDevice >', 'device')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetDeviceRec::IsActive() [member function]
    cls.add_method('IsActive', 
                   'bool', 
                   [])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::SwitchedEthernetDeviceRec::active [variable]
    cls.add_instance_attribute('active', 'bool', is_const=False)
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::SwitchedEthernetDeviceRec::devicePtr [variable]
    cls.add_instance_attribute('devicePtr', 'ns3::Ptr< ns3::SwitchedEthernetNetDevice >', is_const=False)
    return

def register_Ns3SwitchedEthernetHelper_methods(root_module, cls):
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::SwitchedEthernetHelper::SwitchedEthernetHelper(ns3::SwitchedEthernetHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::SwitchedEthernetHelper const &', 'arg0')])
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::SwitchedEthernetHelper::SwitchedEthernetHelper() [constructor]
    cls.add_constructor([])
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::NetDeviceContainer ns3::SwitchedEthernetHelper::Install(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True)
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::NetDeviceContainer ns3::SwitchedEthernetHelper::Install(std::string name) const [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('std::string', 'name')], 
                   is_const=True)
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::NetDeviceContainer ns3::SwitchedEthernetHelper::Install(ns3::Ptr<ns3::Node> node, ns3::Ptr<ns3::SwitchedEthernetChannel> channel) const [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::Ptr< ns3::Node >', 'node'), param('ns3::Ptr< ns3::SwitchedEthernetChannel >', 'channel')], 
                   is_const=True)
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::NetDeviceContainer ns3::SwitchedEthernetHelper::Install(ns3::Ptr<ns3::Node> node, std::string channelName) const [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::Ptr< ns3::Node >', 'node'), param('std::string', 'channelName')], 
                   is_const=True)
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::NetDeviceContainer ns3::SwitchedEthernetHelper::Install(std::string nodeName, ns3::Ptr<ns3::SwitchedEthernetChannel> channel) const [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('std::string', 'nodeName'), param('ns3::Ptr< ns3::SwitchedEthernetChannel >', 'channel')], 
                   is_const=True)
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::NetDeviceContainer ns3::SwitchedEthernetHelper::Install(std::string nodeName, std::string channelName) const [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('std::string', 'nodeName'), param('std::string', 'channelName')], 
                   is_const=True)
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::NetDeviceContainer ns3::SwitchedEthernetHelper::Install(ns3::NodeContainer const & c) const [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::NodeContainer const &', 'c')], 
                   is_const=True)
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::NetDeviceContainer ns3::SwitchedEthernetHelper::Install(ns3::NodeContainer const & c, ns3::Ptr<ns3::SwitchedEthernetChannel> channel) const [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::NodeContainer const &', 'c'), param('ns3::Ptr< ns3::SwitchedEthernetChannel >', 'channel')], 
                   is_const=True)
    ## switched-ethernet-helper.h (module 'switched-ethernet'): ns3::NetDeviceContainer ns3::SwitchedEthernetHelper::Install(ns3::NodeContainer const & c, std::string channelName) const [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::NodeContainer const &', 'c'), param('std::string', 'channelName')], 
                   is_const=True)
    ## switched-ethernet-helper.h (module 'switched-ethernet'): void ns3::SwitchedEthernetHelper::SetChannelAttribute(std::string n1, ns3::AttributeValue const & v1) [member function]
    cls.add_method('SetChannelAttribute', 
                   'void', 
                   [param('std::string', 'n1'), param('ns3::AttributeValue const &', 'v1')])
    ## switched-ethernet-helper.h (module 'switched-ethernet'): void ns3::SwitchedEthernetHelper::SetDeviceAttribute(std::string n1, ns3::AttributeValue const & v1) [member function]
    cls.add_method('SetDeviceAttribute', 
                   'void', 
                   [param('std::string', 'n1'), param('ns3::AttributeValue const &', 'v1')])
    ## switched-ethernet-helper.h (module 'switched-ethernet'): void ns3::SwitchedEthernetHelper::SetQueue(std::string type, std::string n1="", ns3::AttributeValue const & v1=ns3::EmptyAttributeValue(), std::string n2="", ns3::AttributeValue const & v2=ns3::EmptyAttributeValue(), std::string n3="", ns3::AttributeValue const & v3=ns3::EmptyAttributeValue(), std::string n4="", ns3::AttributeValue const & v4=ns3::EmptyAttributeValue()) [member function]
    cls.add_method('SetQueue', 
                   'void', 
                   [param('std::string', 'type'), param('std::string', 'n1', default_value='""'), param('ns3::AttributeValue const &', 'v1', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n2', default_value='""'), param('ns3::AttributeValue const &', 'v2', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n3', default_value='""'), param('ns3::AttributeValue const &', 'v3', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n4', default_value='""'), param('ns3::AttributeValue const &', 'v4', default_value='ns3::EmptyAttributeValue()')])
    ## switched-ethernet-helper.h (module 'switched-ethernet'): void ns3::SwitchedEthernetHelper::EnableAsciiInternal(ns3::Ptr<ns3::OutputStreamWrapper> stream, std::string prefix, ns3::Ptr<ns3::NetDevice> nd, bool explicitFilename) [member function]
    cls.add_method('EnableAsciiInternal', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('std::string', 'prefix'), param('ns3::Ptr< ns3::NetDevice >', 'nd'), param('bool', 'explicitFilename')], 
                   visibility='private', is_virtual=True)
    ## switched-ethernet-helper.h (module 'switched-ethernet'): void ns3::SwitchedEthernetHelper::EnablePcapInternal(std::string prefix, ns3::Ptr<ns3::NetDevice> nd, bool promiscuous, bool explicitFilename) [member function]
    cls.add_method('EnablePcapInternal', 
                   'void', 
                   [param('std::string', 'prefix'), param('ns3::Ptr< ns3::NetDevice >', 'nd'), param('bool', 'promiscuous'), param('bool', 'explicitFilename')], 
                   visibility='private', is_virtual=True)
...
def register_Ns3SwitchedEthernetChannel_methods(root_module, cls):
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::SwitchedEthernetChannel::SwitchedEthernetChannel(ns3::SwitchedEthernetChannel const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::SwitchedEthernetChannel const &', 'arg0')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::SwitchedEthernetChannel::SwitchedEthernetChannel() [constructor]
    cls.add_constructor([])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): int32_t ns3::SwitchedEthernetChannel::Attach(ns3::Ptr<ns3::SwitchedEthernetNetDevice> device) [member function]
    cls.add_method('Attach', 
                   'int32_t', 
                   [param('ns3::Ptr< ns3::SwitchedEthernetNetDevice >', 'device')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetChannel::Detach(ns3::Ptr<ns3::SwitchedEthernetNetDevice> device) [member function]
    cls.add_method('Detach', 
                   'bool', 
                   [param('ns3::Ptr< ns3::SwitchedEthernetNetDevice >', 'device')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetChannel::Detach(uint32_t deviceId) [member function]
    cls.add_method('Detach', 
                   'bool', 
                   [param('uint32_t', 'deviceId')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::DataRate ns3::SwitchedEthernetChannel::GetDataRate() [member function]
    cls.add_method('GetDataRate', 
                   'ns3::DataRate', 
                   [])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::Time ns3::SwitchedEthernetChannel::GetDelay() [member function]
    cls.add_method('GetDelay', 
                   'ns3::Time', 
                   [])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::Ptr<ns3::NetDevice> ns3::SwitchedEthernetChannel::GetDevice(uint32_t i) const [member function]
    cls.add_method('GetDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-channel.h (module 'switched-ethernet'): int32_t ns3::SwitchedEthernetChannel::GetDeviceNum(ns3::Ptr<ns3::SwitchedEthernetNetDevice> device) [member function]
    cls.add_method('GetDeviceNum', 
                   'int32_t', 
                   [param('ns3::Ptr< ns3::SwitchedEthernetNetDevice >', 'device')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): uint32_t ns3::SwitchedEthernetChannel::GetNDevices() const [member function]
    cls.add_method('GetNDevices', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-channel.h (module 'switched-ethernet'): uint32_t ns3::SwitchedEthernetChannel::GetNumActDevices() [member function]
    cls.add_method('GetNumActDevices', 
                   'uint32_t', 
                   [])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::FullDuplexWireState ns3::SwitchedEthernetChannel::GetState(uint32_t deviceId) [member function]
    cls.add_method('GetState', 
                   'ns3::FullDuplexWireState', 
                   [param('uint32_t', 'deviceId')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): ns3::Ptr<ns3::SwitchedEthernetNetDevice> ns3::SwitchedEthernetChannel::GetSwitchedEthernetDevice(uint32_t i) const [member function]
    cls.add_method('GetSwitchedEthernetDevice', 
                   'ns3::Ptr< ns3::SwitchedEthernetNetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True)
    ## switched-ethernet-channel.h (module 'switched-ethernet'): static ns3::TypeId ns3::SwitchedEthernetChannel::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## switched-ethernet-channel.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetChannel::IsActive(uint32_t deviceId) [member function]
    cls.add_method('IsActive', 
                   'bool', 
                   [param('uint32_t', 'deviceId')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetChannel::IsBusy(uint32_t deviceId) [member function]
    cls.add_method('IsBusy', 
                   'bool', 
                   [param('uint32_t', 'deviceId')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): void ns3::SwitchedEthernetChannel::PropagationCompleteEvent(uint32_t deviceId) [member function]
    cls.add_method('PropagationCompleteEvent', 
                   'void', 
                   [param('uint32_t', 'deviceId')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetChannel::Reattach(uint32_t deviceId) [member function]
    cls.add_method('Reattach', 
                   'bool', 
                   [param('uint32_t', 'deviceId')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetChannel::Reattach(ns3::Ptr<ns3::SwitchedEthernetNetDevice> device) [member function]
    cls.add_method('Reattach', 
                   'bool', 
                   [param('ns3::Ptr< ns3::SwitchedEthernetNetDevice >', 'device')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetChannel::TransmitEnd(uint32_t deviceId) [member function]
    cls.add_method('TransmitEnd', 
                   'bool', 
                   [param('uint32_t', 'deviceId')])
    ## switched-ethernet-channel.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetChannel::TransmitStart(ns3::Ptr<ns3::Packet> p, uint32_t srcId) [member function]
    cls.add_method('TransmitStart', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('uint32_t', 'srcId')])
    return

def register_Ns3SwitchedEthernetNetDevice_methods(root_module, cls):
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): static ns3::TypeId ns3::SwitchedEthernetNetDevice::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): ns3::SwitchedEthernetNetDevice::SwitchedEthernetNetDevice() [constructor]
    cls.add_constructor([])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::SetInterframeGap(ns3::Time t) [member function]
    cls.add_method('SetInterframeGap', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::Attach(ns3::Ptr<ns3::SwitchedEthernetChannel> ch) [member function]
    cls.add_method('Attach', 
                   'bool', 
                   [param('ns3::Ptr< ns3::SwitchedEthernetChannel >', 'ch')])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::SetQueue(ns3::Ptr<ns3::Queue> queue) [member function]
    cls.add_method('SetQueue', 
                   'void', 
                   [param('ns3::Ptr< ns3::Queue >', 'queue')])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): ns3::Ptr<ns3::Queue> ns3::SwitchedEthernetNetDevice::GetQueue() const [member function]
    cls.add_method('GetQueue', 
                   'ns3::Ptr< ns3::Queue >', 
                   [], 
                   is_const=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::SetReceiveErrorModel(ns3::Ptr<ns3::ErrorModel> em) [member function]
    cls.add_method('SetReceiveErrorModel', 
                   'void', 
                   [param('ns3::Ptr< ns3::ErrorModel >', 'em')])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::Receive(ns3::Ptr<ns3::Packet> p, ns3::Ptr<ns3::SwitchedEthernetNetDevice> sender) [member function]
    cls.add_method('Receive', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ptr< ns3::SwitchedEthernetNetDevice >', 'sender')])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::IsSendEnabled() [member function]
    cls.add_method('IsSendEnabled', 
                   'bool', 
                   [])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::SetSendEnable(bool enable) [member function]
    cls.add_method('SetSendEnable', 
                   'void', 
                   [param('bool', 'enable')])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::IsReceiveEnabled() [member function]
    cls.add_method('IsReceiveEnabled', 
                   'bool', 
                   [])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::SetReceiveEnable(bool enable) [member function]
    cls.add_method('SetReceiveEnable', 
                   'void', 
                   [param('bool', 'enable')])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::SetEncapsulationMode(ns3::SwitchedEthernetNetDevice::EncapsulationMode mode) [member function]
    cls.add_method('SetEncapsulationMode', 
                   'void', 
                   [param('ns3::SwitchedEthernetNetDevice::EncapsulationMode', 'mode')])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): ns3::SwitchedEthernetNetDevice::EncapsulationMode ns3::SwitchedEthernetNetDevice::GetEncapsulationMode() [member function]
    cls.add_method('GetEncapsulationMode', 
                   'ns3::SwitchedEthernetNetDevice::EncapsulationMode', 
                   [])
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::SetIfIndex(uint32_t const index) [member function]
    cls.add_method('SetIfIndex', 
                   'void', 
                   [param('uint32_t const', 'index')], 
                   is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): uint32_t ns3::SwitchedEthernetNetDevice::GetIfIndex() const [member function]
    cls.add_method('GetIfIndex', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): ns3::Ptr<ns3::Channel> ns3::SwitchedEthernetNetDevice::GetChannel() const [member function]
    cls.add_method('GetChannel', 
                   'ns3::Ptr< ns3::Channel >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::SetMtu(uint16_t const mtu) [member function]
    cls.add_method('SetMtu', 
                   'bool', 
                   [param('uint16_t const', 'mtu')], 
                   is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): uint16_t ns3::SwitchedEthernetNetDevice::GetMtu() const [member function]
    cls.add_method('GetMtu', 
                   'uint16_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::SetAddress(ns3::Address address) [member function]
    cls.add_method('SetAddress', 
                   'void', 
                   [param('ns3::Address', 'address')], 
                   is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): ns3::Address ns3::SwitchedEthernetNetDevice::GetAddress() const [member function]
    cls.add_method('GetAddress', 
                   'ns3::Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::IsLinkUp() const [member function]
    cls.add_method('IsLinkUp', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::AddLinkChangeCallback(ns3::Callback<void,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> callback) [member function]
    cls.add_method('AddLinkChangeCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'callback')], 
                   is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::IsBroadcast() const [member function]
    cls.add_method('IsBroadcast', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): ns3::Address ns3::SwitchedEthernetNetDevice::GetBroadcast() const [member function]
    cls.add_method('GetBroadcast', 
                   'ns3::Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::IsMulticast() const [member function]
    cls.add_method('IsMulticast', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): ns3::Address ns3::SwitchedEthernetNetDevice::GetMulticast(ns3::Ipv4Address multicastGroup) const [member function]
    cls.add_method('GetMulticast', 
                   'ns3::Address', 
                   [param('ns3::Ipv4Address', 'multicastGroup')], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::IsPointToPoint() const [member function]
    cls.add_method('IsPointToPoint', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::IsBridge() const [member function]
    cls.add_method('IsBridge', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::Send(ns3::Ptr<ns3::Packet> packet, ns3::Address const & dest, uint16_t protocolNumber) [member function]
    cls.add_method('Send', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Address const &', 'dest'), param('uint16_t', 'protocolNumber')], 
                   is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::SendFrom(ns3::Ptr<ns3::Packet> packet, ns3::Address const & source, ns3::Address const & dest, uint16_t protocolNumber) [member function]
    cls.add_method('SendFrom', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Address const &', 'source'), param('ns3::Address const &', 'dest'), param('uint16_t', 'protocolNumber')], 
                   is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): ns3::Ptr<ns3::Node> ns3::SwitchedEthernetNetDevice::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::NeedsArp() const [member function]
    cls.add_method('NeedsArp', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::SetReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<ns3::Packet const>, unsigned short, ns3::Address const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    cls.add_method('SetReceiveCallback', 
                   'void', 
                   [param('ns3::Callback< bool, ns3::Ptr< ns3::NetDevice >, ns3::Ptr< ns3::Packet const >, unsigned short, ns3::Address const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'cb')], 
                   is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): ns3::Address ns3::SwitchedEthernetNetDevice::GetMulticast(ns3::Ipv6Address addr) const [member function]
    cls.add_method('GetMulticast', 
                   'ns3::Address', 
                   [param('ns3::Ipv6Address', 'addr')], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::SetPromiscReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<ns3::Packet const>, unsigned short, ns3::Address const&, ns3::Address const&, ns3::NetDevice::PacketType, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    cls.add_method('SetPromiscReceiveCallback', 
                   'void', 
                   [param('ns3::Callback< bool, ns3::Ptr< ns3::NetDevice >, ns3::Ptr< ns3::Packet const >, unsigned short, ns3::Address const &, ns3::Address const &, ns3::NetDevice::PacketType, ns3::empty, ns3::empty, ns3::empty >', 'cb')], 
                   is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): bool ns3::SwitchedEthernetNetDevice::SupportsSendFrom() const [member function]
    cls.add_method('SupportsSendFrom', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## switched-ethernet-net-device.h (module 'switched-ethernet'): void ns3::SwitchedEthernetNetDevice::AddHeader(ns3::Ptr<ns3::Packet> p, ns3::Mac48Address source, ns3::Mac48Address dest, uint16_t protocolNumber) [member function]
    cls.add_method('AddHeader', 
                   'void', 
